...
class CriticNetwork(nn.Module):
    ...
    #     q2 = self.q2(state_action_value)  # Return Q2 as well
    #
    #     return q1, q2  # Return Q1 and Q2
    ...
    def initialize_weights(self):
        ...
        f4 = 0.003
        self.q1.weight.data.uniform_(-f4, f4)
        self.q1.bias.data.uniform_(-f4, f4)

        self.q2.weight.data.uniform_(-f4, f4)
        self.q2.bias.data.uniform_(-f4, f4)
